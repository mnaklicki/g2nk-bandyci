...
/******************************************************************************************/
INSTANCE ItRi_Protection(C_Item)
{
	name 					=	NAME_Ring;
	...
	visual_skin 			=	0;
	material 				=	MAT_METAL;
	on_equip				=	Equip_ItRi_Protection;
	on_unequip				=	UnEquip_ItRi_Protection;

	wear					= 	WEAR_EFFECT;
	effect					=	"SPELLFX_ITEMGLIMMER"; 

	description				= "Pierœcieñ ochrony";
...
FUNC VOID Equip_ItRi_Protection()
{
...
FUNC VOID UnEquip_ItRi_Protection()
{
	self.protection [PROT_EDGE] 		-=  5;
	self.protection [PROT_BLUNT]		-=  5;
