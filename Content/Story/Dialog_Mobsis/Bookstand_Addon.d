...
FUNC VOID Use_Bookstand_Addon_BL_S1()		
{
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLines	( nDocID,  0, "Nie mam pojêcia czemu Kruk przyj¹³ do naszej bandy tych idiotów. Ju¿ wola³bym szkodników z Nowego Obozu. To kompletne nieroby, a po tej akcji z kopalni¹ czêœæ naszej bandy siê pozabija³a. Mam nadziejê, ¿e Kruk to ogarnie, bo na razie spêdza czas w œwi¹tyni, a mi nie pozwala wydawaæ g³ównych decyzji. Na dodatek awansowa³ Bloodwyna, a ten panoszy siê po kopalni i œwi¹tyni.");			
					
					Doc_SetMargins	( nDocID, -1, 30, 20, 275, 20, 1   		);
					Doc_PrintLines	( nDocID,  1, "Alvaro dosta³ rozkaz pilnowania niewolników, którzy szukaj¹ jakiegoœ grobowca. Szkoda, bo mi bardzo pomaga³ w organizacji. Na moje szczêœcie Fletcher rz¹dzi dolnym obozem i zdo³a³ to ogarn¹æ. Myœlê, ¿e za tydzieñ ca³y obóz bêdzie idealnie funkcjonowa³. Pozostaje sprawa z wpuszczaniem do kopalni i paroma cz³onkami obozu. Mo¿e wykorzystamy te czerwone tabliczki. Wydaj¹ siê bezu¿yteczne.");
					Doc_Show		( nDocID );
