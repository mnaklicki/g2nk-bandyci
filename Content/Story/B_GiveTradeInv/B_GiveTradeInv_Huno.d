...
FUNC VOID B_GiveTradeInv_Huno (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Huno_ItemsGiven_Chapter_1 == FALSE))
	{
	...
	if ((Kapitel >= 2)
	&& (Huno_ItemsGiven_Chapter_2 == FALSE))
	{
		CreateInvItems (slf, ItMiSwordraw, 3); 
		CreateInvItems (slf, ItMi_Nugget, 1); 
	...
	if ((Kapitel >= 3)
	&& (Huno_ItemsGiven_Chapter_3 == FALSE))
	{
		CreateInvItems (slf, ItMiSwordraw, 3); 
		CreateInvItems (slf, ItMi_Nugget, 1); 
	...
	if ((Kapitel >= 4)
	&& (Huno_ItemsGiven_Chapter_4 == FALSE))
	{
		CreateInvItems (slf, ItMiSwordraw, 3); 
		CreateInvItems (slf, ItMi_Nugget, 1); 
	...
	if ((Kapitel >= 5)
	&& (Huno_ItemsGiven_Chapter_5 == FALSE))
	{
		CreateInvItems (slf, ItMiSwordraw, 3); 
